...
const Navbar = () => {
  ...
  return (
    <nav className='bg-transparent border-gray-200 px-2 sm:px-4 py-2.5 rounded'>
      <div className='container flex flex-wrap justify-between item mx-auto'>
      ...
      <div className={`w-full md:block md:w-auto ${isNavExpanded? "expanded" : "hidden"}`} id="navbar-default">
        <ul className="flex flex-col p-4 mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent">
